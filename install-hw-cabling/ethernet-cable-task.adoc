...
[NOTE]
====
ストレージシステムによっては、各コントローラに帯域外Ethernet管理ポートが1つしか搭載されていないものもあります。

お使いのストレージ システムに固有のケーブル接続手順については、link:../getting-started/getup-run-concept.html["Eシリーズのクイックスタートガイド"^]を参照して、お使いのストレージ システムのリンクをクリックしてください。
