...
---
= Linux構成がサポートされていることを確認し、Eシリーズ（NVMe over InfiniBand）の制限事項を確認する
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
NVMe over InfiniBandを使用する前に、を参照してください https://mysupport.netapp.com/matrix["NetApp Interoperability Matrix Tool で確認できます"^] をクリックして、コントローラ、ホスト、およびリカバリの最新の制限事項を確認してください。
