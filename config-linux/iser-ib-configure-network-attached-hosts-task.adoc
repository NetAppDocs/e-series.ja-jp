...
+
*Red Hat Enterprise Linux 8、9、10 (RHEL 8、RHEL 9、RHEL 10)*
...
----
+
*SUSE Linux Enterprise Server 12、15、16 (SLES 12、SLES 15、SLES 16)*
...
iscsiadm -m session
----
.. アレイからiSCSIセッションのステータスを確認します。SANtricity System Managerで、*設定* > *システム* > *iSCSIセッションの表示/終了*に移動します。
