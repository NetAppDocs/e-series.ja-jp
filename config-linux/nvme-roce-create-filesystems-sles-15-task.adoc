...
---
= Eシリーズでファイルシステムを作成する - Linux RHEL 8、RHEL 9、RHEL 10、SLES 15、SLES 16 (NVMe over RoCE)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
RHEL 8、RHEL 9、RHEL 10、SLES 15、SLES 16 の場合、ネイティブ nvme デバイス上にファイルシステムを作成し、そのファイルシステムをマウントします。
