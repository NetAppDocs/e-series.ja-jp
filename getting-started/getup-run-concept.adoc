...
Eシリーズハードウェアをインストールするには、ストレージアレイとシェルフタイプ（該当する場合）のインストールおよびセットアップ手順を参照してください：

[role="quick-margin-list"]
* link:../install-hw-ef50-ef80/install-workflow.html["EF50またはEF80ストレージ システム"^]
...
[role="quick-margin-list"]
* https://docs.netapp.com/us-en/e-series-santricity/system-manager/index.html["SANtricity System Manager 12.0xオンラインヘルプ"^]
* https://docs.netapp.com/us-en/e-series-santricity-119/system-manager/index.html["SANtricity System Manager 11.9xオンラインヘルプ"^]
