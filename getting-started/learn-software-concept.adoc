...
Unified Managerは、ドメイン全体を管理するために使用するWebベースのソフトウェアです。中央ビューから、EF50、EF80、E4000、E2800、EF280、EF300、E5700、EF570、EF600、EF300C、EF600Cなど、すべての新しいEシリーズおよびEFシリーズアレイのステータスを確認できます。選択したストレージアレイに対してバッチ操作を実行することもできます。
...
コマンドラインインターフェース（CLI）は、ストレージアレイの設定と監視を行うための手段を提供するソフトウェア アプリケーションです。CLIを使用すると、 `DOS C:`プロンプト、Linuxオペレーティングシステムのパス、Solarisオペレーティングシステムのパスなど、オペレーティングシステムのプロンプトからコマンドを実行できます。
