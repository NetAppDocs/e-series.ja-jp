...
|===
これらの前提条件がお客様のインストール環境に当てはまらない場合、またはより詳細な概念的背景情報が必要な場合は、以下の技術レポートを参照してください： https://www.netapp.com/pdf.html?item=/media/17017-tr4789.pdf["『 VMware Configuration Guide for E-Series SANtricity iSCSI Integration with ESXi 6.X 』"^]
